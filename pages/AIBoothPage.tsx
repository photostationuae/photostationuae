...
const AIBoothPage: React.FC<BasePageProps> = ({ navigate, lang }) => {
    return (
        <div className="py-16 md:py-24 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-800">{t(lang, 'serviceAITitle')}</h1>
                    <img src="https://picsum.photos/seed/futurebooth-page/1200/600" alt={t(lang, 'serviceAITitle')} className="my-8 rounded-lg shadow-lg" />
                    <p className="mt-4 text-lg text-gray-600">{t(lang, 'serviceAIDesc')}</p>
