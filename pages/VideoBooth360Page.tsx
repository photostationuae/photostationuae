        ...
        <div className="py-16 md:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <img src="https://picsum.photos/seed/360booth-page/1200/600" alt={t(lang, 'service360Title')} className="my-8 rounded-lg shadow-lg" />
                    <p className="mt-4 text-lg text-gray-600">{t(lang, 'service360Desc')}</p>
                    <button
